...
> 21개의 오프라인 STT 모델, 20개의 로컬 TTS 음성에 Deepgram Aura까지, 5개 탭을 갖춘 하나의
...
모든 설정은 한곳에 모여 있습니다: `/voice-settings`. 5개 탭이 필요한 모든 것을 다룹니다.
...
# settings and UI
extensions/voice/settings-panel.ts          설정 패널 — 오버레이, 5개 탭
